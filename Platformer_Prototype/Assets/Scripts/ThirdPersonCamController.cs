...
public class ThirdPersonCamController : MonoBehaviour {
	...
	void Update () {
        ...
        crosshairpivot.rotation *= Quaternion.Euler(0f, Input.GetAxis("Mouse X") * -sensitivity, 0f);
        crosshairpivot.rotation *= Quaternion.Euler(Input.GetAxis("Mouse Y") * -sensitivity, 0f, 0f);
    }*/
}
